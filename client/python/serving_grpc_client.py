...
def grpc_predict_raw(input):
    ...
    tensor_protos = {
        'last_note_creators': tf.make_tensor_proto(input['last_note_creators'], dtype=tf.string, shape=[1, 50]),#1
        'last_note_ids': tf.make_tensor_proto(input['last_note_ids'], dtype=tf.int64, shape=[1, 50]),#2
        'note_open_id': tf.make_tensor_proto(input['note_open_id'], dtype=tf.string, shape=[1]),#3
        'note_id': tf.make_tensor_proto(input['note_id'], dtype=tf.int64, shape=[1]),#4
        'note_video_duration': tf.make_tensor_proto(input['note_video_duration'], dtype=tf.int64, shape=[1])#5
    }
